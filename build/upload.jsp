...
<body>
    <div class="container">
        <h1>📤 Test Upload de Fichiers</h1>
        
        <div class="info">
            <strong>Note:</strong> Ce formulaire teste l'upload de fichiers avec des paramètres supplémentaires.
        </div>
        ...
        <form action="upload" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="categorie" name="categorie" value="Documents">
            </div>
